...
uniform float startFadePercent;
uniform float totalFadePercent;
...
void main() {
	...
	vec4 fragColor = vec4(glowColor, 1 - (clamp(value, startFadePercent, 1) - startFadePercent) / (totalFadePercent - startFadePercent));
